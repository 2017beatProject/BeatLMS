...
<%
LMSNoticeDto bean=(LMSNoticeDto)request.getAttribute("noticeAdminGenEdit");
%>	
...
<form action="notice_admin_gen_edit.lms?lmsblog=<%=bean.getLmsblog()%>" name="adminGenEdit" method="post">
			<div id="contentlayout">
				...
				<div id="addbtn">
					<a href="javascript:adminGenEdit.submit();">완료</a>
				</div>
			</div>
</form>
		</div>
