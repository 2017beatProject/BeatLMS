...
<link rel="stylesheet" href="./css/notice_notice_general_detail.css">
	...
	<div class="content grid_10">
		...
		<div class="layout">
			...
			<div id="contentlayout">
				<div id="insidelayout">
		<%
		LMSNoticeDto bean=(LMSNoticeDto)request.getAttribute("noticeGenDetail");
		%>
						<div class="title">
				...
				<div id="addbtn">
					<a href="notice_general.lms">목록</a>
				</div>
			</div>
		</div>
