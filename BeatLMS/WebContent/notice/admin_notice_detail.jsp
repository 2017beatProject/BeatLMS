...
<link rel="stylesheet" href="./css/notice_admin_notice_detail.css">
	...
	<div class="content grid_10">
		...
		<div class="layout">
			...
			<div id="contentlayout">
				<div id="insidelayout">
		<%
		LMSNoticeDto bean=(LMSNoticeDto)request.getAttribute("noticeAdminDetail");
		%>
						<div class="title">
				...
				<div id="addbtn">
					<a href="notice_admin.lms">목록</a> <a href="notice_admin_edit.lms?lmsblog=<%=bean.getLmsblog() %>">수정</a>
				</div>
			</div>
		</div>
